...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-indigo-200 via-purple-200 to-pink-200">
      <img
        onClick={() => navigate("/")}
        src={assets.logo}
        className="absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer"
      ...
      <div className="bg-slate-900/95 border border-white/10 p-10 rounded-2xl shadow-2xl w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form onSubmit={onSubmitHandler}>
          {state === "Sign Up" && (
            <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C] focus-within:ring-2 focus-within:ring-indigo-400">
          ...
          <p
            ...
            className="mb-4 text-sm cursor-pointer underline hover:text-indigo-200"
          >
            Forgot Password?
          </p>

          <button className="w-full py-2.5 rounded-full text-white font-medium shadow-lg bg-gradient-to-r from-indigo-600 to-violet-600 hover:opacity-95">
            {state}
          </button>
        </form>
        ...
        {state === "Sign Up" ? (
          <p className="mt-4 text-center text-xs">
            ...
            <span onClick={() => setState("Login")} className="cursor-pointer underline">
              Login here
            </span>
          </p>
        ) : (
          <p className="mt-4 text-center text-xs">
            ...
            <span onClick={() => setState("Sign Up")} className="cursor-pointer underline">
              Sign Up
            </span>
          </p>
        )}
